...
part1_routes = Blueprint('part1_routes', '__name__', template_folder='templates', static_folder='static')


@part1_routes.route('/menu_name_columns')
...
@part1_routes.route('/get_name_columns/<table>')
...
@part1_routes.route('/menu_nicknames')
def menu_nicknames():
...
@part1_routes.route('/get_nicknames/<city>')
def get_nicknames(city):
    query = "SELECT nick_name FROM mentors WHERE city='{}'".format(city)
    result = data_manager.handle_database(query)
    if result['result'] == 'success':
        title = 'The nick_names of all mentors working at {}'.format(city)
        return render_template('result.html',
                            title=title,
                            column_names=result['column_names'], rows=result['rows'], row_count=result['row_count'])
    else:
...
@part1_routes.route('/menu_full_name_and_phone_from_fist_name')
...
@part1_routes.route('/get_full_name_and_phone_from_fist_name/<name>')
...
@part1_routes.route('/menu_applicant_from_email')
...
@part1_routes.route('/get_applicant_from_email/<email>')
...
@part1_routes.route("/menu_insert_applicant_data")
...
@part1_routes.route("/get_inserted_applicant_data")
...
@part1_routes.route("/menu_update_applicant_data")
...
@part1_routes.route('/update_applicant_data/<name>')
...
@part1_routes.route("/get_updated_applicant_data")
...
@part1_routes.route('/menu_remove_applicants_by_email_domain')
...
@part1_routes.route('/remove_applicants_by_email_domain/<domain>')
